    ...
    return (
        <footer className="footer p-10 bg-orange-50 text-base-content">
            ...
            <form>
                ...
                <h3 className='text-[#908F8D]'>Subscribe to our newsletter to get <br />updates about our grand offers.</h3>
                <fieldset className="form-control w-80">
                    ...
                    <div className="join">
                        ...
                        <button className="btn btn-primary join-item border-none bg-[#902727]">Subscribe</button>
                    </div>
                </fieldset>
            </form>
        </footer>
