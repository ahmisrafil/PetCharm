    ...
    return (
        <div className='mx-20 my-10'>
            ...
            <div className='flex flex-row gap-6 justify-between '>
                <div>
                    <img src={img1} className='rounded-full h-40' alt="" />
                    <h3 className='font-bold text-center '>Birds Food</h3>
                </div>
                <div>
                    <img src={img2} className='rounded-full h-40' alt="" />
                    <h3 className='font-bold text-center '>Cats Health Suppliments</h3>
                </div>
                <div>
                    <img src={img3} className='rounded-full h-40' alt="" />
                    <h3 className='font-bold text-center '>Cats Dry Food</h3>
                </div>
                <div>
                    <img src={img4} className='rounded-full h-40' alt="" />
                    <h3 className='font-bold text-center '>Cats Treats</h3>
                </div>
                <div>
                    <img src={img5} className='rounded-full h-40' alt="" />
                    <h3 className='font-bold text-center '>Cats Fashion</h3>
                </div>
                <div>
                    <img src={img6} className='rounded-full h-40' alt="" />
